...
const Resister = () => {
    ...
    const image_APi_URL =`https://api.imgbb.com/1/upload?=${import.meta.env.VITE_img_host_key}`
...
অন্তত 1টা সংখ্যা (0-9)</p>}
        ...
        <p>Already have an account? <Link className='text-blue-600 underline text-xl' to={'/logIn'}> Login </Link></p>
